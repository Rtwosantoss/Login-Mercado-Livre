<template>
    ...
    <div class="mb-8 flex justify-center">
      <img class="w-24" src="https://www.pngfind.com/pngs/m/367-3678855_mercado-livre-logo-mercado-livre-png-transparent-png.png" alt="" />
    </div>
    <div class="flex flex-col text-sm rounded-md">
      <input class="mb-5 rounded-[4px] border p-3 hover:outline-none focus:outline-none hover:border-yellow-500 " type="text" placeholder="Usuário ou Email" />
      <input class="border rounded-[4px] p-3 hover:outline-none focus:outline-none hover:border-yellow-500" type="password" placeholder="Senha" />
    </div>
    <button class="mt-5 w-full border p-2 bg-blue-500 text-white rounded-[4px] hover:bg-slate-400 scale-105 duration-300" type="submit">Sign in</button>
